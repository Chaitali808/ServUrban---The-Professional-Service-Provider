...
<head>
  ...
  <div id="pcoded" class="pcoded">
      ...
      <div class="pcoded-container navbar-wrapper">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          ...
                                          <div class="media-body">
                                              <h5 class="notification-user">Chaitali Bhavsar</h5>
          ...
          <div style="background-image: url('./resources/assets/images/uDashboardbg.jpg'); background-size: cover; background-position: center;"class="pcoded-main-container">
