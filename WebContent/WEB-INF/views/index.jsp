            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action = "afterLogin" method ="post">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="uContact" class="form-control" required="">
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                                <a href="userSignup" class="text-right f-w-600"> Create Account</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20"><a href="spLogin">Service Provider</a></button>
                                        </div>
                                    </div>
                                    <hr/>
