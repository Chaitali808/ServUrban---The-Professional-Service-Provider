...
<head>
  ...
  <!-- Pre-loader end -->
    ...
    <div class="row">
       ...
       <!-- ================================================================================================================ -->             
                        <form class="md-float-material form-material" action ="afterUserSignup" method="post">
                           ...
                           <div class="card-block">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="tel" name="uContact" class="form-control" required="">
                                            <span class="form-bar"></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group form-primary">
                                            ...
                                            <input type="date" name="uDob" class="form-control" required="">
                                            <span class="form-bar"></span>
                                            
                                        </div>
                                        
                                        <div class="form-group form-primary">
                                            <input type="pincode" name="uPincode" class="form-control" required="">
                                            <span class="form-bar"></span>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group form-primary">
                                            <input type="text" name="uArea" class="form-control" required="">
                                            <span class="form-bar"></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="text" name="uCity" class="form-control" required="">
                                            <span class="form-bar"></span>
