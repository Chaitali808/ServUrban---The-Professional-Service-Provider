...
<head>
    <title>Professional Services Provider </title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action ="afterAdminLogin" method ="post">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label">Admin Id</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" name="adminName" class="form-control" required="">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Admin Name</label>
                                    </div>
                                    <div class="form-group form-primary">
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" ><a href="spLogin">Service Provider Login</a> </button>
                                        </div>
                                   
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20"><a href="index">User Login</a></button>
                                        </div>
                                    </div>
                                    <hr/>
