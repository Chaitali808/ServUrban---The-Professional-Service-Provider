          ...
          <div class="pcoded-main-container">
              <div class="pcoded-wrapper">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="uHouseholdServices" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-21">Household Services</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="uCateringServices" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-21">Catering Services</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                         </li>
                                         <li class="">
                                            <a href="uProfessionalServices" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-21">Professional Services</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="">
                                            <a href="uProfessionalServices" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-21">BeautyParlour Services</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                              </li>
               ...
               <%  List<ServiceProvider> serviceProvider = (List<ServiceProvider>)request.getAttribute("serviceProvider");
               		String uPincode =  (String)request.getAttribute("uPincode"); 
               		String sptype=  (String)request.getAttribute("serviceType"); 

              	int i=0;	
               for(ServiceProvider sp : serviceProvider){
              		//	if(sp.getServiceType().equals("sptype")&& sp.getSpStatus().equals("Approved")&& sp.getSpPincode().equals(uPincode)){
              				i++;
              %>
                                                        <tr>
                                                            <th scope="row">i</th>
												            ...
												            <a href="bookOrder/<%= sp.getSpContact() %>">
